...
| 6 | Wireshark Packet Capture & Protocol Analysis | Windows 11 + Linux | 5.0 | 🔜 Upcoming |
| 7 | Static & Dynamic Routing (OSPF) | Cisco Packet Tracer | 2.0 | 🔜 Upcoming |
| 8 | Network Troubleshooting — OSI-Based Methodology | Win VMs + Packet Tracer | 5.0 | 🔜 Upcoming |
...
|---|---|---|
| 1.0 Networking Concepts | 23% | 1, 3, 4 |
| 2.0 Network Implementation | 20% | 1, 7 |
| 3.0 Network Operations | 17% | 4 |
| 4.0 Network Security | 20% | 2, 5 |
| 5.0 Network Troubleshooting | 20% | 6, 8 |
...
- DNS and DHCP server configuration and troubleshooting
